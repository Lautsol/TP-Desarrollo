...
public class ModificarItemMenu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel22.setText("Modificar item menú");
        ...
        JButton2.setActionCommand("CancelarModificar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarItemMenu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarItemMenu().setVisible(true);
            }
        });
    }
