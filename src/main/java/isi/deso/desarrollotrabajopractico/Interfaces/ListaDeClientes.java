...
public class ListaDeClientes extends javax.swing.JPanel {
    ...
    public void agregarClienteALaTabla(String nombre, int id, long cuit, String alias, Long cbu, String email, String direccion) {
       DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
       jTable1.setModel(model);
       Object[] rowData;
       
       if(cbu == null) {
           rowData = new Object[] { nombre, id, cuit, alias, "", email, direccion, null };
       }
       else rowData = new Object[] { nombre, id, cuit, alias, cbu, email, direccion, null };
